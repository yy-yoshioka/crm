    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <div className="bg-white dark:bg-gray-800 overflow-hidden shadow rounded-lg">
          ...
          <div className="bg-gray-50 dark:bg-gray-700 px-5 py-3">
            <div className="text-sm">
              <Link href="/customers" className="font-medium text-blue-700 hover:text-blue-900 dark:text-blue-500 dark:hover:text-blue-300">
                View all
              </Link>
            </div>
          </div>
        ...
        <div className="bg-white dark:bg-gray-800 overflow-hidden shadow rounded-lg">
                ...
                <dl>
                  ...
                  <dd className="flex items-baseline">
                    ...
                    <div className="ml-2 flex items-baseline text-sm font-semibold text-green-600 dark:text-green-400">
                      {totalCount > 0 && (
                        <span className="text-xs">{Math.round((activeCount / totalCount) * 100)}%</span>
                      )}
                    </div>
                  </dd>
                </dl>
          ...
          <div className="bg-gray-50 dark:bg-gray-700 px-5 py-3">
            <div className="text-sm">
              <Link href="/customers?status=active" className="font-medium text-blue-700 hover:text-blue-900 dark:text-blue-500 dark:hover:text-blue-300">
                View active
              </Link>
            </div>
          </div>
        ...
        <div className="bg-white dark:bg-gray-800 overflow-hidden shadow rounded-lg">
                ...
                <dl>
                  ...
                  <dd className="flex items-baseline">
                    ...
                    <div className="ml-2 flex items-baseline text-sm font-semibold text-yellow-600 dark:text-yellow-400">
                      {totalCount > 0 && (
                        <span className="text-xs">{Math.round((pendingCount / totalCount) * 100)}%</span>
                      )}
                    </div>
                  </dd>
                </dl>
          ...
          <div className="bg-gray-50 dark:bg-gray-700 px-5 py-3">
            <div className="text-sm">
              <Link href="/customers?status=pending" className="font-medium text-blue-700 hover:text-blue-900 dark:text-blue-500 dark:hover:text-blue-300">
                View pending
              </Link>
            </div>
          </div>
        ...
        <div className="bg-white dark:bg-gray-800 overflow-hidden shadow rounded-lg">
                ...
                <dl>
                  ...
                  <dd className="flex items-baseline">
                    ...
                    <div className="ml-2 flex items-baseline text-sm font-semibold text-gray-600 dark:text-gray-400">
                      {totalCount > 0 && (
                        <span className="text-xs">{Math.round((inactiveCount / totalCount) * 100)}%</span>
                      )}
                    </div>
                  </dd>
                </dl>
          ...
          <div className="bg-gray-50 dark:bg-gray-700 px-5 py-3">
            <div className="text-sm">
              <Link href="/customers?status=inactive" className="font-medium text-blue-700 hover:text-blue-900 dark:text-blue-500 dark:hover:text-blue-300">
                View inactive
              </Link>
            </div>
          </div>
        ...
        <div className="divide-y divide-gray-200 dark:divide-gray-700">
          {recentCustomers && recentCustomers.length > 0 ? (
            ...
            <div className="px-6 py-4 text-sm text-gray-500 dark:text-gray-400">
              No customers yet. <Link href="/customers/new" className="text-blue-600 dark:text-blue-500 hover:underline">Add a customer</Link>
            </div>
          )}
        </div>
