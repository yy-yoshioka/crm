...
export async function generateMetadata({ params }: CustomerDetailPageProps): Promise<Metadata> {
  ...
  return {
    title: customer ? `${customer.name} | Customer Details` : 'Customer Details',
      ...
      <div className="bg-white dark:bg-gray-800 shadow rounded-lg overflow-hidden">
        <div className="p-6 border-b border-gray-200 dark:border-gray-700">
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center">
            ...
            <span className={`mt-2 sm:mt-0 px-3 py-1 rounded-full text-sm font-medium ${statusStyles[customer.status]}`}>
          ...
          <div>
            ...
            <div className="mt-3 space-y-4">
              ...
              <div>
                ...
                <p className="mt-1 text-base text-gray-900 dark:text-white">
                  {customer.address || <span className="text-gray-500 dark:text-gray-400">Not provided</span>}
                </p>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="mt-3 space-y-4">
              <div>
                ...
                <p className="mt-1 text-base text-gray-900 dark:text-white">
                  {customer.created_by_user?.email || <span className="text-gray-500 dark:text-gray-400">Unknown</span>}
                </p>
              </div>
              
              <div>
                <p className="text-sm font-medium text-gray-500 dark:text-gray-400">Created Date</p>
                <p className="mt-1 text-base text-gray-900 dark:text-white">{formattedCreatedAt}</p>
              </div>
              
              <div>
                <p className="text-sm font-medium text-gray-500 dark:text-gray-400">Last Updated</p>
                <p className="mt-1 text-base text-gray-900 dark:text-white">{formattedUpdatedAt}</p>
              </div>
            </div>
          </div>
        </div>
